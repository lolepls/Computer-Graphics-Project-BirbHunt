...
This utility script has been assembled by taking functions from various source files provived by Professors.

- matrixUtils: function to build matrices
- objUtils: functions to load models
*/
